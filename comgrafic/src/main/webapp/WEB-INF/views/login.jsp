    ...
    <div class="row">
        ...
        <div class="form col-md-auto mt-1">
            <form action="/login" method="POST" class="form-signin">
                ...
                <%--<input type="text" id="username" role="username" class="form-control"--%>
                ...
                <%--<div textalign="center" th:if="${param.error}">--%>
                        <%--<p style="font-size: 20; color: #FF1C19;">Password invalid, please verify</p>--%>
                    <%--</div>--%>

                <div class="row">
                    <div class="col-sm">
                        <input class="btn btn-lg btn-light btn-block" type="submit" name="action"  value="Submit" style="background-color: #610B4B; color: #ffffff"/>
                    </div>
                </div>
